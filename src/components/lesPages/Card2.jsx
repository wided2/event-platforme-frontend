...
import Image1 from "../../assets/evenement/communauté.jpg"; // Import de l'image
...
const events = [
  {
    ...
    description:
      "sont des événements ou des campagnes organisés pour récolter de l'argent en soutien à une cause spécifique, comme des projets caritatifs",
    category: "  Communautaire et Caritatif",
    startDate: "10 Mars 2025, 9:00 AM",
    endDate: "10 Mars 2025, 5:00 PM",
    location: " Bizert-rasjbal",
    capacity: "50 Participants",
    price: "60 dt",
    creator: "Mr Alex",
    creationDate: "01 Février 2025",
  },
];
