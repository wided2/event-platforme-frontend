...
const events = [
  { id: 1, name: "Fête d'anniversaire", category: " Nettoyages de plages", date: "2025-03-17" },
  { id: 2, name: "Réunion", category: "Nettoyages de plages", date: "2025-03-17" },
  { id: 3, name: "Festival de musique", category: "  Ateliers éco-responsables", date: "2025-03-19" },
  { id: 4, name: "Féte de famille", category: " Ateliers éco-responsables", date: "2025-03-21" },
  // Autres événements
];
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-6">
        <h2 className="text-2xl font-semibold mb-4">Catégorie 
        Ecologie et Environnement</h2>
        <p className="mb-4">Voici la section des événements de la catégorie 
        Ecologie et Environnement...</p>
