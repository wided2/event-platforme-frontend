...
const events = [
  { id: 1, name: "Fête d'anniversaire", category: "Compétitions sportives", date: "2025-03-17" },
  { id: 2, name: "Réunion", category: "Compétitions sportives", date: "2025-03-17" },
  { id: 3, name: "Festival de musique" ,category: "Cours de fitness", date: "2025-03-19" },
  { id: 4, name: "Féte de famille", category: "Cours de fitness", date: "2025-03-21" },
  // Autres événements
];
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-6">
        <h2 className="text-2xl font-semibold mb-4">Catégorie Sport et Bien-être</h2>
        <p className="mb-4">Voici la section des événements de la catégorie Sport et Bien-être...</p>
