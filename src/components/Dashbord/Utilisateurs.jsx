...
const Utilisateurs = () => {
  ...
  <div className="flex justify-center items-center w-full">
    <form className="w-full md:w-1/2 space-y-4" onSubmit={onSubmit}>
      ...
      <div>
        <label htmlFor="message" className="block text-gray-700 font-semibold">Votre message :</label>
        <textarea 
          required
          name="message"
          className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 h-48"
          placeholder="Votre message"
        ></textarea>
      </div>
      <button 
        type="submit"
        className="bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600 transition transform hover:scale-105 active:scale-95"
