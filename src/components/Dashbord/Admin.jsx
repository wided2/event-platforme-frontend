      ...
      <aside className="w-64 bg-gradient-to-b from-orange-400 to-orange-400 text-white h-screen p-6 shadow-lg">
        ...
        <nav>
          <ul className="space-y-4">
            ...
            <li
              onClick={() => handleFeatureSelection("roles")}
              className={`cursor-pointer flex items-center gap-3 p-2 rounded-lg ${
                selectedFeature === "roles" ? "bg-orange-600" : "hover:bg-orange-400"
              } transition duration-300`}
            >
              <span>👥</span> Gérer les Catégorie
            </li>
            <li
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {selectedFeature === "users" && (
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-orange-400 mb-4">Gérer les utilisateurs</h2>
              <p className="text-gray-600">
                Contenu pour gérer les utilisateurs...
              </p>
            </div>
          )}
          {selectedFeature === "roles" && (
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Contenu pour gérer les Catégories...
              </p>
            </div>
          )}
